...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-calendar me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      Master Data Tahun Ajaran
    </h1>
    <p>Kelola data tahun ajaran dalam sistem EMIS</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @include('admin.master._import-modal', ['entity' => 'tahun-ajaran'])
    @include('admin.master._sync-modal', ['entity' => 'tahun-ajaran'])
    @livewire('emis.master-tahun-ajaran')
  </div>
</div>
@endsection
