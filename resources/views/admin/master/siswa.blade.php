...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-user-check me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      Master Data Siswa
    </h1>
    <p>Kelola data siswa dalam sistem EMIS</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @include('admin.master._import-modal', ['entity' => 'siswa'])
    @include('admin.master._sync-modal', ['entity' => 'siswa'])
    @livewire('emis.master-siswa')
  </div>
</div>
@endsection
