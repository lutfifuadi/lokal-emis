...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-door-enter me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      Master Data Kelas
    </h1>
    <p>Kelola data kelas dalam sistem EMIS</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @include('admin.master._import-modal', ['entity' => 'kelas'])
    @include('admin.master._sync-modal', ['entity' => 'kelas'])
    @livewire('emis.master-kelas')
  </div>
</div>
@endsection
