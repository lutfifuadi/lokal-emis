...
@section('title', $siswaId ? 'Edit Siswa' : 'Tambah Siswa')
...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-user-plus me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      {{ $siswaId ? 'Edit Siswa' : 'Tambah Siswa' }}
    </h1>
    <p>{{ $siswaId ? 'Perbarui data siswa dalam sistem EMIS' : 'Tambahkan data siswa baru ke dalam sistem EMIS' }}</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @livewire('emis.master-siswa-form', ['siswaId' => $siswaId])
  </div>
</div>
@endsection
