...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-building-bank me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      Master Data Sekolah
    </h1>
    <p>Kelola data sekolah dalam sistem EMIS</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @include('admin.master._import-modal', ['entity' => 'sekolah'])
    @include('admin.master._sync-modal', ['entity' => 'sekolah'])
    @livewire('emis.master-sekolah')
  </div>
</div>
@endsection
