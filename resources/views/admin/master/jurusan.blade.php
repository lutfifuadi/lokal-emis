...
<div class="emis-page-header mb-6">
  <div class="emis-page-header-content">
    <h1>
      <i class="ti tabler-git-branch me-2" style="font-size:1.3rem;vertical-align:middle;opacity:.8;"></i>
      Master Data Jurusan
    </h1>
    <p>Kelola data jurusan dalam sistem EMIS</p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    @include('admin.master._import-modal', ['entity' => 'jurusan'])
    @include('admin.master._sync-modal', ['entity' => 'jurusan'])
    @livewire('emis.master-jurusan')
  </div>
</div>
@endsection
