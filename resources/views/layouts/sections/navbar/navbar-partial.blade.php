...
$profileUrl = url('pages/profile-user');
if (Auth::check()) {
  $userRole = Auth::user()->roles->first()?->name;
  if (in_array($userRole, ['Siswa', 'Orang Tua'])) {
    $profileUrl = route('siswa.profil');
  }
}
@endphp
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0"
            href="{{ Route::has('profile.show') ? route('profile.show') : $profileUrl }}">
